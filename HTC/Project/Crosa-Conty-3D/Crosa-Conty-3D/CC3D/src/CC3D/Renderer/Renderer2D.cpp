...
namespace CC3D {
	...
	void Renderer2D::Init()
	{
		...
		size_t tex_size = 1;
		s_Data->WhiteTexture = Texture2D::Create(tex_size, tex_size);
	...
	{
		s_Data->TextureShader->SetFloat4("u_Color", glm::vec4(1.0f));//texture should use white multiple with its own color
		texture->Bind();
