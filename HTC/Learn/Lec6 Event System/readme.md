...
(You could install the component of [Class Designer](https://www.youtube.com/watch?v=syYyQ7LlcPc) to see the **class diagram**)
...
Log.h in CC3D : add header file

```
#include "spdlog/fmt/ostr.h"
```

Application.cpp in CC3D : modify run function to test our event system
