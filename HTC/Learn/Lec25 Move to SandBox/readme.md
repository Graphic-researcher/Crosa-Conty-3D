...
tutorial : [here](https://www.youtube.com/watch?v=4zj-0FQ7Xbg&list=PLlrATfBNZ98dC-V-N3m0Go4deliWHPFwT&index=36)

code version : [here](https://github.com/Graphic-researcher/Crosa-Conty-3D/tree/033acc1aebeb281925e087332b72ad6a5cf99e5f/HTC/Project/Crosa-Conty-3D/Crosa-Conty-3D)

Now we want our engine core more clean,so we will move the rendering related code to sandbox scope,
...
Application Scope has return to the profile of  implementing rendering before.

check out it [here](https://github.com/Graphic-researcher/Crosa-Conty-3D/tree/HTC/HTC/Learn/Lec17%20Render%20Context)

## Build and Result

Press ↑↓←→ to move camera,press A/a and D/d to rotate camera
